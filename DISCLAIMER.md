# Disclaimer & Acceptable Use — nopal

`nopal` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`nopal` is a general-purpose developer tool. Like most general-purpose tools, it

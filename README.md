...
Gmail, Calendar, Drive, Sheets, Docs, Slides, Chat, Tasks — 8개 서비스를 자연어 한마디로 자동 조합해서 실행합니다. 서비스 하나씩 따로 열 필요 없이, "회의 준비해줘"라고 말하면 캘린더 확인 → 문서 생성 → 메일 발송까지 한번에.
...
- **동적 조합입니다.** 미리 정해진 워크플로우만 실행하는 게 아닙니다. 어떤 요청이든 8개 서비스를 조합해서 처리합니다.

...
description: Nopal 핵심 오케스트레이션 엔진. 사용자의 자연어 요청을 분석하여 Google Workspace 8개 서비스를 동적으로 조합 실행합니다. 커맨드에서 Read로 읽혀 참고 자료로 사용됩니다.
---
...
요청에서 키워드와 의도를 추출하여 8개 서비스 중 어떤 것이 필요한지 판별한다.
...
8. **gws CLI 설치를 자동으로 하지 마.** 안내만 하고 사용자가 직접 설치하도록 한다.
